...
import { newProduct, categories } from "../../data/data";
...
export default function IndexFour(){
    return(
        ...
        <section className="relative md:flex table w-full items-center md:h-screen py-36 bg-[url('../../assets/images/hero/bg4.jpg')] bg-center bg-no-repeat bg-cover">
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 justify-center">
                    <div className="text-center">
                        ...
                        <div className="mt-6">
                            <Link to="#" className="py-2 px-5 inline-block font-semibold tracking-wide align-middle text-center bg-white text-orange-500 rounded-md">Shop Now <i className="mdi mdi-arrow-right"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
