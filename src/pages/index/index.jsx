...
export default function Index(){
    ...
    return(
        ...
        <section className="relative md:flex table w-full items-center md:h-screen py-36 pt-[74px] bg-emerald-500/5 md:bg-top bg-center bg-no-repeat bg-cover" style={{backgroundImage:`url(${heroBg})`}}>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 pt-6 gap-6">
            ...
            <div className="container-fluid relative md:mt-24 mt-16">
                <div className="grid grid-cols-1">
                    <div className="relative overflow-hidden py-24 px-4 md:px-10 bg-orange-600 bg-center bg-no-repeat bg-cover" style={{backgroundImage:`url(${heroBg})`}}>
                        ...
                        <div className="grid grid-cols-1 justify-center text-center relative z-1 h-[300px]">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 pt-6 gap-6">
                    {newProduct.slice(0,4).map((item, index) =>{
                        return(
                            <div className="group" key={index}>
                                <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                    <img src={item.image} className="group-hover:scale-110 duration-500" alt=""/>
